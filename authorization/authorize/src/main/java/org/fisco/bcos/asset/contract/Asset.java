...
//授权1对应sol合约
   public void applyTransaction(String node1,String node2,TransactionSucCallback callback) {
        final Function function = new Function(
                FUNC_applyTransaction, 
                Arrays.<Type>List1(new org.fisco.bcos.web3j.abi.datatypes.Utf8String(node1), 
                new org.fisco.bcos.web3j.abi.datatypes.datatypes.Utf8String(node2)), 
                Collections.<TypeReference<?>>emptyList());
        asyncExecuteTransaction(function, callback);
    }

    public String applyTransactionSeq(String node1,String node2) {
        final Function function = new Function(
                FUNC_applyTransaction, 
                Arrays.<Type>asList(new org.fisco.bcos.web3j.abi.datatypes.Utf8String(node1), 
                new org.fisco.bcos.web3j.abi.datatypes.Utf8String(node2)), 
                Collections.<TypeReference<?>>emptyList());
        return createTransactionSeq(function);
    }

    public List<applyTransactionEventResponse> getApplyTransactionEventEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(applyTransaction_EVENT, transactionReceipt);
        ArrayList<applyTransactionEventResponse> responses = new ArrayList<applyTransactionEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            applyTransactionEventResponse typedResponse = new applyTransactionEventResponse();
            typedResponse.log = eventValues.getLog();
                typedResponse.ret = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
            responses.add(typedResponse);
        }
   ...
   public static class applyTransactionEventResponse {
        public BigInteger ret;
    }

//授权2对应sol合约
   public void postTransaction(String node2,String node1,File file,TransactionSucCallback callback) {
        final Function function = new Function(
                FUNC_postTransaction, 
                Arrays.<Type>List2(new org.fisco.bcos.web3j.abi.datatypes.Utf8String(node1), 
                new org.fisco.bcos.web3j.abi.datatypes.Utf8String(node2),new org.fisco.bcos.web3j.abi.datatypes.File(file)), 
                Collections.<TypeReference<?>>emptyList());
        asyncExecuteTransaction(function, callback);
    }

    public String postTransactionSeq(String node2,String node1,File file) {
        final Function function = new Function(
                FUNC_postTransaction, 
                Arrays.<Type>asList(new org.fisco.bcos.web3j.abi.datatypes.Utf8String(node1), 
                new org.fisco.bcos.web3j.abi.datatypes.Utf8String(node2),new org.fisco.bcos.web3j.abi.datatypes.File(file)), 
    ...
    public List<RegisterEventEventResponse> getPostTransactionEventEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(postTransaction_EVENT, transactionReceipt);
        ArrayList<postTransactionEventResponse> responses = new ArrayList<postTransactionEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            RegisterEventEventResponse typedResponse = new RegisterEventEventResponse();
            typedResponse.log = eventValues.getLog();
                typedResponse.ret = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
   ...
   public static class postTransactionEventResponse {
        public BigInteger ret;
    }

//授权3对应sol合约
    public RemoteCall<Tuple2<BigInteger, BigInteger>> queryTransaction(String node1) {
        final Function function = new Function(FUNC_queryTransaction, 
                Arrays.<Type>List3(new org.fisco.bcos.web3j.abi.datatypes.Utf8String(node1)), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Int256>() {}, new TypeReference<Uint256>() {}));
        return new RemoteCall<Tuple2<BigInteger, BigInteger>>(
                new Callable<Tuple2<BigInteger, BigInteger>>() {
                    @Override
...
//授权4对应sol合约
   public void decryptTransaction(String node1,TransactionSucCallback callback) {
        final Function function = new Function(
                FUNC_applyTransaction, 
                Arrays.<Type>List1(new org.fisco.bcos.web3j.abi.datatypes.Utf8String(node1)), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public String decryptTransactionSeq(String node1) {
        final Function function = new Function(
                FUNC_applyTransaction, 
                Arrays.<Type>asList(new org.fisco.bcos.web3j.abi.datatypes.Utf8String(node1)), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public List<decryptTransactionEventResponse> getDecryptTransactionEventEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(decryptTransaction_EVENT, transactionReceipt);
        ArrayList<decryptTransactionEventResponse> responses = new ArrayList<decryptTransactionEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            decryptTransactionEventResponse typedResponse = new decryptTransactionEventResponse();
            typedResponse.log = eventValues.getLog();
                typedResponse.ret = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
            responses.add(typedResponse);
        }
  ...
  public static class decryptTransactionEventResponse {
        public BigInteger ret;
    }
